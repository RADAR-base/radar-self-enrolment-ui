import {  completeVerificationFlow, IUpdateRecoveryFlowBodyCode, IUpdateRecoveryFlowBodyEmail } from "@/app/_lib/auth/ory/kratos"
...
export async function POST(request: NextRequest) {
  ...
  return completeVerificationFlow(flowId, data)
}