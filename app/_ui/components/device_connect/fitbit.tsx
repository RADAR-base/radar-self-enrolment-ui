      ...
      <Grid container spacing={2} padding={3} gap={2} rowGap={4}>
        <Grid size={12} textAlign={'left'}>
          <div>
            ...
            <Typography>
              Read our <Link component={NextLink} href={'/study/paprka/resources/guides/PAPrKA_Study_Guide_Fitbit.pdf'} target="_blank">Guide</Link> or view our <Link href="https://youtu.be/cPYi0-3fmQ4" target="_blank">Video</Link> for more detailed instructions on how to share your Fitbit data.  
            </Typography>
          </div>
        </Grid>
