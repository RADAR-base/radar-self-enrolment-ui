...
const PDF_PAGE: Record<string, number> = {
  ...
  'M-Permission to access/work with NJR': 1,
  'M-Agree data in publications': 1,
...
const PDF_COORDS: Record<string, Point | Rect> = {
  ...
  first_name: [75, 228],
  last_name: [234, 228],
  signature: [70, 390, 510, 490],
  'M-Confirmed read': [500, 265],
  'M-Ack vol involvement': [500, 350],
  'M-Ack understand involvement': [500, 430],
  'M-Permission to collect PGHD': [500, 515],
  'M-Permission to create joined dataset': [500, 640],
  'M-Permission to access/work with NJR': [500, 110],
  'M-Agree data in publications': [500, 165],
  'M-Ack regulatory access': [500, 220],
  'M-Agree take part': [500, 276],
  'O-Agree UoM holding data': [500, 400],
  'O-Prize draw': [500, 490],
  'O-Contact future': [500, 550],
  'O-Summary findings': [500, 594],
  'O-Newsletter': [500, 635],
};
